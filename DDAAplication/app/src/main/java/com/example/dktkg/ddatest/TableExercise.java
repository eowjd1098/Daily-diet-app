...
public class TableExercise extends YouTubeBaseActivity implements
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (select_item[0].equals("다리")) {
                    Intent intent = new Intent(TableExercise.this, TableExercise.class);
                    startActivity(intent);
                    finish();
                } else if (select_item[0].equals("뱃살")) {
                    Intent intent = new Intent(TableExercise.this, TableExercise_two.class);
                    startActivity(intent);
                    finish();
                }
            }
    ...
    public void onInitializationSuccess(Provider provider,YouTubePlayer player, boolean wasRestored) {
        if (!wasRestored) {
            player.cueVideo("59ylvWlszgg");
            /**
            /http://www.youtube.com/watch?v=IA1hox-v0jQ
